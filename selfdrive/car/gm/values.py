...
class CarControllerParams():
  def __init__(self):
    ...
    self.ACCEL_MAX = 1.25 # m/s^2 (max accel of sport profile in longitudinal_planner.py)
    ...
    self.GAS_LOOKUP_BP = [-0.35, 0., self.ACCEL_MAX]
    self.GAS_LOOKUP_V = [self.MAX_ACC_REGEN, self.ZERO_GAS, self.MAX_GAS]
    self.BRAKE_LOOKUP_BP = [self.ACCEL_MIN, -0.35]
